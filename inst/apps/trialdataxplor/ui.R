...
ui <- fluidPage(
  ...
  #tags$div(  div(img(src="ibpcirad.png", height="34px", border.radius="6px",
  #                   style="border-radius: 6px;
  #              width:129px;
  #              height:34px;
  #              margin-right:10px"),"BMS trial data explorer", style="font: 500 20px/32px Roboto,Helvetica Neue,sans-serif;"),
